...
from .lightseq_transformer_encoder_layer import LSTransformerEncoderLayer


@register_encoder
class LSTransformerEncoder(AbstractEncoder):
    """
    ...
    Args:
        ...
        activation_dropout: activation function used in feed-forward network
    ...
    def build(self, embed, special_tokens):
        ...
        self._layers = nn.ModuleList([LSTransformerEncoderLayer(d_model=self._d_model,
                                                                nhead=self._n_head,
