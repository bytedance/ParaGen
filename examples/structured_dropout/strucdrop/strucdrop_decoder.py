...
from .strucdrop_decoder_layer import StructuredDropDecoderLayer
from .layerdrop import LayerDropModuleList, config_to_params


@register_decoder
class StructuredDropDecoder(AbstractDecoder):
    """
    ...
    def build(self,
        ...
        self._layers.extend(
            [StructuredDropDecoderLayer(d_model=self._d_model,
                                        nhead=self._n_head,
